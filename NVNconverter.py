...
content_new5_ = re.sub(r'  DWORD_', r'0x', content_new5, flags = re.M)
content_new5x = re.sub(r'  DAT_', r'0x', content_new5_, flags = re.M)
content_new6 = re.sub('= (.*),"', '', content_new5x, flags = re.M)
